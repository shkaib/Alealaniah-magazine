                                    ...
                                    @else
                                    	...
                                    	@foreach( $salesman as $salesmans )
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $salesmans->email }}</td>
                                                <td>{{ $salesmans->phone }}</td>
                                                <td>{{ $salesmans->created_at }}</td>
                                                <td>@if( $salesmans->active == 1 )
                                                        <span style="color:green">Active</span>
                                                    @else
                                                        <span style="color:red">Unactive</span>
                                                    @endif</td>
                                                <td class="text-center">
                                                	@if( $salesmans->active == 1 )
                                                        <a href="{{ URL::route('blockSalesMan', [$salesmans->id]) }}">
                                                            <span class="fa fa-ban" aria-hidden="true"> </span>
                                                        </a>
                                                    @else
                                                        <a href="{{ URL::route('activeSalesMan', [$salesmans->id]) }}">
                                                    ...
                                                    <a href="{{ URL::route('deleteSalesMan', [$salesmans->id]) }}"> 
