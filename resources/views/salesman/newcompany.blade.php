			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                    	All Ads  | 
                        	@if( count($myads) == 1 )
                            	Total Ad {{ count($myads) }}
                            @elseif( count($myads)  == 0 )
                            	Nothing Found
                            @elseif(count($myads) > 1)
                        		Total Ads {{ count($myads) }}
                            @endif
    ...
    <tbody>
    	...
    	<tr>
            ...
            <td>
                 ...
                 <!-- View Ad -->
                 <a href="{{ URL::route('editMyAd', [$ad->id], [$ad->name]) }}" class="col-lg-4 nogape">
                 ...
                 <!-- View Ad -->
                 <a href="{{ URL::route('single-ad', [$ad->id]) }}" class="col-lg-4 nogape">
