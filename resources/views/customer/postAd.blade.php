						...
						<div class="col-md-6">
							<form role="form" method="post" enctype="multipart/form-data" 
								...
								<div class="form-group">
									...
									<input type="text" id="phone" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="Enter Phone Number">
								</div>
								
								
								<div class="form-group">
									<label for="address">Address</label>
									<input type="text" name="address" class="form-control" placeholder="Address" id="address" value="{{ old('address') }}" 
										@if( !empty($ad->address) )
                                        	{{ $ad->address }}
                                        @endif
                                    >
